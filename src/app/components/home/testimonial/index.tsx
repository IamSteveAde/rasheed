...
export default function SecurityTrust() {
  ...
  return (
    <section className="relative py-28 bg-[#f8fafc] overflow-hidden" id="security">

      {/* Subtle ring background pattern */}
      ...
      <div className="relative z-10 container mx-auto lg:max-w-screen-xl px-6">
        ...
        <div className="max-w-2xl mb-16">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            We use enterprise-grade data protection and WhatsApp’s end-to-end
            encryption to keep your information safe — the same security trusted
        ...
        <div className="flex items-center gap-6 mb-16">
          <div className="px-5 py-2 bg-white rounded-full border border-gray-200 shadow-sm flex items-center gap-2">
          ...
          <div className="px-5 py-2 bg-white rounded-full border border-gray-200 shadow-sm flex items-center gap-2">
            <span className="text-green-600 text-xl">✔</span>
            <span className="text-gray-700 font-medium">Data Encrypted</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-10">
          {partners.map((p, idx) => (
            <div
              key={idx}
              className="flex items-center justify-center grayscale opacity-90 hover:opacity-100 hover:grayscale-0 transition"
            >
              <Image
